...
@Service
public class LayananPenggunaImpl
        implements LayananPengguna {
    ...
    @Override
    public Pengguna updatePengguna(
            Pengguna pengguna) {

        return repoPengguna.save(pengguna);
    }
    ...
    @Override
    public PenggunaAktif tambahWarga(
            PenggunaAktif warga) {
        ...
        // DEFAULT STATUS
        if (warga.getStatus() == null
                || warga.getStatus().isEmpty()) {
    ...
    @Override
    public List<PenggunaAktif> wargaByRtRw(
            String rtRw) {
    ...
    @Override
    public List<Petugas> petugasByWilayah(
            String wilayah) {

        return repoPetugas
                .findByWilayahTugas(wilayah);
    }
}